...
const TDCALL_STATUS_OPERAND_BUSY: u64 = 0x8000020000000001;
const TDCALL_ACCEPTPAGE_MAX_RETRY: u32 = 5;
...
impl From<u64> for TdCallError {
    fn from(val: u64) -> Self {
        // According to TDX module spec 4.1.3 Function Completion Status
        // Codes Table 4.4: Function Completion Status Code Definition
        // Error value is in 63:32.
        match val >> 32 {
